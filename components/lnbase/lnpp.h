...
#define LN_PP_ARGS                                                          7, 6, 5, 4, 3, 2, 1, 0
#define LN_PP_CAL_ARGS_SIZE_IMPL(e0, e1, e2, e3, e4, e5, e6, e7, SIZE, ...) SIZE
#define LN_PP_ARGS_AUGMENTER(...)                                           unused, __VA_ARGS__
#define LN_PP_ARGS_EXPAND(...)                                              LN_PP_EXPAND(LN_PP_CAL_ARGS_SIZE_IMPL(__VA_ARGS__, LN_PP_ARGS))
#define LN_PP_CAL_ARGS_SIZE(...)                                            LN_PP_EXPAND(LN_PP_ARGS_AUGMENTER(__VA_ARGS__))
