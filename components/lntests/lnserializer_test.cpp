...
using namespace ln;
using binary_t = serialization_container<std::string, serialization_options::LN_BINARY | serialization_options::LN_NO_HEADER | serialization_options::LN_COMPACTED>;
...
public:
    ...
    bool operator==(const custom_data_t& other)
    {
        return u8 == other.u8 && u16 == other.u16
               && f32 == other.f32 && f64 == other.f64 && str == other.str;
    }
};
LN_TYPE_INFO_FIELDS_DECL(custom_data_t, u8, u16, f32, f64, str);

TEST(lnserializer, test_custom)
{
    constexpr auto ff = binary_t::ops;
    constexpr auto vv = &custom_data_t::u8;
    binary_t       bin;
    custom_data_t  v1;
    v1.u8  = 0xff;
    v1.u16 = 0xff;
